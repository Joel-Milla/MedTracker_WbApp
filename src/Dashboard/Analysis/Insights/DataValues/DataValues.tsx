        ...
        <>
            ...
            <div className="flex justify-around">
                ...
                <div>
                    ...
                    <p className="text-2xl 2xl:text-4xl font-semibold">4,200</p>
                </div>
                <div>
                    <h2 className="text-sm text-gray-500">Promedio</h2>
                    <p className="text-2xl 2xl:text-4xl font-semibold">9,000</p>
                </div>
                <div>
                    <h2 className="text-sm text-gray-500">Maximo</h2>
                    <p className="text-2xl 2xl:text-4xl font-semibold">18,000</p>
                </div>
            </div>
        </>
    )
